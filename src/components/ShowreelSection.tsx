...
export default function ShowreelSection() {
  ...
  return (
    <section
      id="showreel"
      ref={sectionRef}
      className="relative py-20 sm:py-28 md:py-32 px-4 sm:px-8 lg:px-12 bg-[#050505] border-t border-white/10 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-6 sm:mb-8">
          {SHOWREEL_VIDEOS.map((item, idx) => (
            <button
              ...
              className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-mono-code text-xs uppercase tracking-wider transition-all duration-300 ${
                activeTab === idx
        ...
        <div
          ref={videoWrapperRef}
          className="relative w-full aspect-[16/9] md:aspect-[21/9] rounded-2xl sm:rounded-3xl overflow-hidden bg-black border border-white/30 shadow-2xl group"
        ...
        >
          ...
          {/* Top Label */}
          <div className="absolute top-4 left-4 sm:top-6 sm:left-6 font-mono-code text-[10px] sm:text-xs font-bold text-white bg-black/80 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/25">
          ...
          <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 flex items-center justify-between z-10">
            <div className="flex items-center gap-2.5 sm:gap-3">
              <button
                onClick={togglePlay}
                className="p-2.5 sm:p-3 rounded-full bg-white text-black hover:bg-zinc-200 transition-colors shadow-lg cursor-pointer"
              ...
              <button
                onClick={toggleMute}
                className="p-2.5 sm:p-3 rounded-full bg-black/80 backdrop-blur-md text-white border border-white/25 hover:bg-white/20 transition-colors cursor-pointer"
            ...
            <span className="font-mono-code text-[11px] sm:text-xs text-zinc-300 hidden sm:block">
