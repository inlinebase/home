...
export default function RestaurantPortfolioPage() {
  ...
  const restaurantProjects = PROJECTS.filter((p) => p.category === "restaurant");
    ...
    <main className="relative min-h-screen bg-black text-white">
      ...
      <section className="pt-40 pb-16 px-6 md:px-12 max-w-7xl mx-auto space-y-6">
        ...
        <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tighter text-white">
          Restaurant & Café Platforms.
        </h1>

        <p className="text-base sm:text-lg text-neutral-400 font-light max-w-3xl leading-relaxed">
          Cinematic culinary web platforms for Michelin dining, artisanal coffee roasteries, and hospitality groups. Integrated reservation management, tasting menu reveals, and online gift cards.
        </p>
      </section>
