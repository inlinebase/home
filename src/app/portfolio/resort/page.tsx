...
export default function ResortPortfolioPage() {
  const [isBookCallOpen, setIsBookCallOpen] = useState(false);
  const resortProjects = PROJECTS.filter((p) => p.category === "resort");
    ...
    <main className="relative min-h-screen bg-black text-white">
      ...
      <section className="pt-40 pb-16 px-6 md:px-12 max-w-7xl mx-auto space-y-6">
        ...
        <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tighter text-white">
          Resorts & Luxury Villas.
        </h1>

        <p className="text-base sm:text-lg text-neutral-400 font-light max-w-3xl leading-relaxed">
          Ultra-luxury hospitality web portals with immersive full-bleed imagery, suite customizers, interactive resort walkthroughs, and direct booking engine integration.
        </p>
      </section>
